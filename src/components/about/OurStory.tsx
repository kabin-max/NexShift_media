      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-none z-0">
        <style>{`
          @keyframes float-wave-1 {
            ...
            100% { transform: translateX(2%) scaleY(0.95); }
          }
          ...
          .animate-wave-1 { animation: float-wave-1 14s ease-in-out infinite alternate; will-change: transform; transform-origin: top; }
          .animate-wave-2 { animation: float-wave-2 18s ease-in-out infinite alternate; will-change: transform; transform-origin: top; }
        `}</style>
        <svg
          viewBox="0 0 1200 120"
          preserveAspectRatio="none"
          className="relative block w-[200%] md:w-[120%] h-[100px] md:h-[150px] left-1/2 -translate-x-1/2"
        >
          <defs>
            <linearGradient id="wave-gradient" x1="0" x2="1" y1="0" y2="0">
              <stop offset="0%" stopColor="#03b364" />
              <stop offset="50%" stopColor="#028a4c" />
              <stop offset="100%" stopColor="#03b364" />
            </linearGradient>
          </defs>
          ...
          <path
            d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z"
            fill="url(#wave-gradient)"
            className="opacity-90 drop-shadow-lg animate-wave-2"
          ></path>
        </svg>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-12 lg:gap-16 z-10 relative">
          ...
          <div className="w-full text-center flex flex-col items-center justify-center gap-6">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-xl md:text-2xl text-transparent bg-clip-text bg-gradient-to-r from-[#0D7A95] via-[#14A9D6] to-[#2E73B8] font-medium tracking-wide drop-shadow-sm">
                A journey of creativity, strategy, and relentless pursuit of excellence.
              </h3>
            </div>
          </div>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full">
          ...
          <div className="lg:col-span-4 grid grid-cols-3 lg:flex lg:flex-col gap-3 sm:gap-6">
            <ScrollReveal direction="up" delay={0.1} className="flex-1">
              <div className="h-full bg-white/70 backdrop-blur-2xl border border-white/40 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl p-3 sm:p-8 flex flex-col justify-center items-center text-center hover:shadow-lg hover:-translate-y-1 hover:border-[#14A9D6]/30 transition-all duration-300 group">
            ...
            <ScrollReveal direction="up" delay={0.25} className="flex-1">
